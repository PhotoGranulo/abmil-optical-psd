...
def run_train(args):
    ...
    batch_size_val = 16  # number of val/test samples is 96
    ...
    data = helper.wrapper_make_data_split_sample_level(
    ...
    batches_per_epoch = math.ceil(X_train_prepro.shape[0] / args.batch_size)
    validation_steps = math.ceil(X_val_prepro.shape[0] / batch_size_val)
